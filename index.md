...
By accepting the Terms & Conditions, you agree to use SkiNav contingently with the terms set forth herein.  

---

## 2. Description of the SkiNav app
SkiNav provides recreational ski navigation, run selection, lift guidance, and route planning based on publicly available and proprietary map data.  
The SkiNav app does not provide real-time snow conditions, weather information, or safety-certified navigation.
...
Local ski conditions, closures, hazards, and posted signs always take precedence over any route provided within the SkiNav app.
...
- Prioritise local signage over SkiNav 
- Maintain awareness of surroundings  
- Ski within their abilities  
- Not rely solely on the SkiNav app for safety-critical decisions 

SkiNav accepts no responsibility for negligent behaviour resulting from failure to observe the above points.

---

## 5. Location Data
SkiNav may request access to the device location to improve route accuracy.  
...
The developer does not guarantee that any information displayed in the SkiNav app, including but not limited to maps, trail status, lift operations, or estimated skiing durations, is accurate, complete, or up-to-date.
...
To the maximum extent permitted by law, the developer is not liable for any injury, accident, or loss arising from use of SkiNav, including but not limited to:
- skiing accidents  
...
## 10. Changes to the SkiNav app
The SkiNav app's content, features, or functionality may change at any time without notice.
...
## 12. Contact
Questions about these Terms may be directed through the SkiNav app Store listing.
...
- **Anonymous analytics** to understand how the SkiNav app is used and improve stability, usability, and performance in line with GDPR Art. 6(1)(a)
...
## 6. EU Representative (Article 27 GDPR)
...
- Delete the SkiNav app to remove all locally stored data  

User-level and event-level analytics data will automatically be deleted after 14 months of inactivity or uninstalling the SkiNav app.
